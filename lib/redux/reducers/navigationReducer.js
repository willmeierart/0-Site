import { GET_ROUTE_STATE, SET_SCROLL_POS, CONFIG_SCROLL_ENV, GET_TRANSITION_DIR } from '../actions/types'
...
export default function navigationReducer (state = initialState, action) {
  switch (action.type) {
    ...
    case GET_TRANSITION_DIR : {
      const newState = { ...state }
      newState.transitionDir = action.payload
      return newState
    }
    default:
      return state
